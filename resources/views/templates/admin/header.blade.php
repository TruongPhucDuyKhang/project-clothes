...
<!-- //font-awesome icons -->
{{-- <script src="public/templates/admin/js/jquery2.0.3.min.js"></script> --}}
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="public/templates/admin/images/3.png"></span>
                        <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="public/templates/admin/images/1.png"></span>
                        <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="public/templates/admin/images/2.png"></span>
                        <span class="subject">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <img alt="" src="storage/app/avatar/{{ Auth::user()->picture }}">
                @else
                <img alt="" src="storage/app/avatar/images.png">
                @endif
                <span class="username">{{ Auth::user()->fullname }}</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="{{ route('auth.auth.logout') }}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
